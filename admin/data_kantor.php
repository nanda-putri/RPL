...
require("../koneksi.php");
require "session.php";
$tampil = "SELECT*FROM kantor";
$hasil_user = mysqli_query($koneksi, $tampil);
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <erh4 class="card-title">Data Kantor</erh4>
                                <div class="d-flex">
                                    <a href="form_data_kantor.php"><button class="btn btn-primary btn-sm ">+ Tambah Data</button></a>
                                </div>
                            </div>
                            ...
                            <div class="card-body px-0 pb-0">
                                <div class="table-responsive">
                                    <table class="table mb-0" id="table1">
                                        ...
                                        <tbody>
                                            <?php
                                            while ($rows = mysqli_fetch_assoc($hasil_user)) {
                                            ?>
                                                <tr>
                                                    <td><?= $rows["id_kantor"] ?></td>
                                                    <td><?= $rows["nama_kantor"] ?></td>
                                                    <td><?= $rows["alamat_kantor"] ?></td>
                                                    <td>
                                                        <a href="hapus_data_kantor.php?idkantor=<?= $rows["id_kantor"] ?>">
