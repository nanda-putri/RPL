...
$hasil_kendaraan = mysqli_query($koneksi, $tampil);
?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex">
                                    <a href="form_data_kendaraan.php"><button class="btn btn-primary btn-sm ">+ Tambah Data</button></a>
                                </div>
                            </div>
                            ...
                            <div class="card-body px-0 pb-0">
                                <div class="table-responsive">
                                    <table class="table mb-0" id="table1">
                                        ...
                                        <tbody>
                                            <?php
                                            while ($rows = mysqli_fetch_assoc($hasil_kendaraan)) {
                                            ?>
                                                <tr>
                                                    <td><?= $rows["id_kendaraan"] ?></td>
                                                    <td><?= $rows["nama_kendaraan"] ?></td>
                                                    <td><?= $rows["plat_nomer"] ?></td>
                                                    <td><?= $rows["jumlah_kursi"] ?></td>
                                                    <td>
                                                        <a href="form_edit_data_kendaraan.php?id=<?= $rows["id_kendaraan"] ?>"><i data-feather="edit" style="color: green;"></i></a>
                                                        <a href="hapus_data_kendaraan.php?idkendaraan=<?= $rows["id_kendaraan"] ?>"><i data-feather="trash-2" style="color: red;"></i></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
