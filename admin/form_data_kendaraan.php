...
<body>
    ...
    if (isset($_POST["submit"])) {
        ...
        $cek_kendaraan = "SELECT*FROM kendaraan WHERE plat_nomer = '$plat_nomer'";
        $hasil_cek = mysqli_query($koneksi, $cek_kendaraan);
        if (mysqli_num_rows($hasil_cek) == 0) {
            ...
            echo "<script>Swal.fire('Berhasil','Data Telah Ditambahkan','success')</script>";
        } else {
            echo "<script>Swal.fire('ERROR','Plat nomor sudah ada','error')</script>";
        }
    }
    ?>
    <div id="app">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <erh4 class="card-title">Tambah Data Kendaraan</erh4>
                            </div>
                            ...
                            <div class="card-body px-0 pb-0">
                                <form action="" method="POST">
                                    <div class="m-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="plat_nomer" class="form-label">Plat Nomor</label>
                                            <input type="text" class="form-control" id="plat_nomer" name="plat_nomer" required>
                                        </div>
                                        <div class="mb-3">
